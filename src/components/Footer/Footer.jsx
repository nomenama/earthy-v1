...
const Footer = () => {
    return (
        <footer className="w-full bg-[#0b0706]">
            <div className="max-w-[90%] 3xl:max-w-[80%] mx-auto py-[50px] flex flex-col-reverse lg:flex-row justify-between lg:gap-[100px] gap-10">
                <div className="flex-1 flex flex-col flex-wrap sm:flex-row sm:justify-between sm:items-start gap-[50px] sm:gap-6">
                    <h4 className="text-white text-2xl text-center">Earthy</h4>
